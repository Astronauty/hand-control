...
DEFAULTS = {
    ...
    "JOG_VEL":          0.35,  # m/s   peak wrist-tracking speed cap
    "WRIST_TRACK_GAIN": 8.0,   # 1/s   P-gain on wrist position error
    "JOG_QDOT_MAX":     2.5,   # rad/s final per-joint arm-rate cap
